...
def recommend_properties_with_scores(property_name, top_n=247):
    ...
    cosine_sim_matrix = 0.8*cosine_sim1 + 0.5*cosine_sim2 + 1*cosine_sim3
...
# 2_feature Recomendation on the Bassis of the Selected Appartment
